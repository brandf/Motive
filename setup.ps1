...
Write-Color Yellow "motive                                    # Run with default config"
Write-Color Yellow "motive -c tests/configs/integration/game_test.yaml         # Run test configuration"
Write-Color Yellow "motive-analyze                           # Analyze configurations"
Write-Color Blue "Or, after activating, you can also use:"
Write-Color Yellow "python -m motive.main                    # Alternative way to run"
